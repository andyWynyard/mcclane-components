...
var breakpoints = ['319px', '424px', '767px', '1023px', '1200'];
...
var Typography = {
    ...
    SmallParagraph: createComponent(typographyStyles.ParagraphSmall, 'SmallParagraph'),
    Link: Link$1,
};
...
exports._type = function (x) {
    return Object.prototype.toString.call(x).slice(8, -1);
};
exports._get = function (path, obj, defaultValue) {
    var head = path[0];
    var tail = path.slice(1);
    if (!tail.length) {
        var res = obj[head];
        var isEmpty = (exports._type(res) === 'Object' && Object.keys(res).length === 0) ||
            exports._type(res) === 'Null' ||
            exports._type(res) === 'Undefined';
        return isEmpty ? defaultValue : obj[head];
    }
    return exports._get(tail, obj[head], defaultValue);
};
exports._withMinAndMaxMedia = function (x, y) {
    return "@media (min-width: " + x + ") and (max-width: " + y + ")";
};
exports._makeErrorMessage = function (breakName, breaks) {
    return "'" + breakName + "' is invalid breakpoint name. Use '" + Object.keys(breaks).join(', ') + "'.";
};
exports._makeStyledBreakpoints = function (options) {
    var _options = options || {};
    var state = {
        ...
        throwInvalidBreakValue: function (breaks) {
        ...
        throwIsInvalidBreakName: function (breakName, breaks) {
            state.invariant(breaks[breakName], exports._makeErrorMessage(breakName, breaks));
        },
        throwIsLastBreak: function (breakName, breaks) {
        ...
        throwIsInvalidNextBreakValue: function (name, breaks) {
            state.invariant(breaks[name], "'" + name + "' is invalid breakpoint name. Use '" + Object.keys(breaks)
                .slice(0, -1)
                .join(', ') + "'.");
        },
        throwIsInvalidOrientation: function (x) {
            state.invariant(x === 'portrait' || x === 'landscape', "'" + x + "' is invalid orientation. Use 'landscape' or 'portrait'.");
        },
        withOrientationOrNot: function (x, y) {
            if (y) {
        ...
        getBreakpointsFromTheme: function (theme) {
            return exports._get(state.pathToMediaQueries, theme, state.defaultMediaQueries);
        },
        getNextBreakpointName: function (name) {
        ...
        getNextBreakpointValue: function (name, breaks) {
        ...
        getBreakpointValue: function (name, breaks) {
            state.throwIsInvalidBreakName(name, breaks);
            return breaks[name];
        },
        calcMinWidth: function (name, theme) {
            return state.toEm(state.getBreakpointValue(name, state.getBreakpointsFromTheme(theme)));
        },
        calcMaxWidth: function (name, theme) {
            return state.toEm(state.getNextBreakpointValue(name, state.getBreakpointsFromTheme(theme)));
        },
        up: function (name, orientation) {
            return function (props) {
                return state.withOrientationOrNot("@media (min-width: " + state.calcMinWidth(name, props.theme) + ")", orientation);
            };
        },
        down: function (name, orientation) {
            return function (props) {
                return state.withOrientationOrNot("@media (max-width: " + state.calcMaxWidth(name, props.theme) + ")", orientation);
            };
        },
        between: function (min, max, orientation) {
            return function (props) {
                return state.withOrientationOrNot(exports._withMinAndMaxMedia(state.calcMinWidth(min, props.theme), state.calcMaxWidth(max, props.theme)), orientation);
            };
        },
        only: function (name, orientation) {
            return function (props) {
                return state.withOrientationOrNot(exports._withMinAndMaxMedia(state.calcMinWidth(name, props.theme), state.calcMaxWidth(name, props.theme)), orientation);
            };
        },
    };
    return state;
};
var bp = exports._makeStyledBreakpoints();
exports.up = bp.up;
exports.down = bp.down;
exports.between = bp.between;
exports.only = bp.only;
});

var H2 = Typography.H2, H4 = Typography.H4, Paragraph = Typography.Paragraph;
var FlipCardWrapper = styled(GenericComponent)(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  perspective: 1500px;\n  position: relative;\n  height: 520px;\n\n  ", " {\n    height: auto;\n    box-shadow: 0 1.5rem 4rem #00000033;\n    background-color: #fff;\n  }\n  @media only screen and (hover: none) {\n    height: auto;\n    box-shadow: 0 1.5rem 4rem #00000033;\n    background-color: #fff;\n  }\n\n  .front {\n    height: 520px;\n    transition: all 0.8s ease;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    backface-visibility: hidden;\n    border-radius: 3px;\n    overflow: hidden;\n    box-shadow: 0 15px 40px #00000033;\n    background-color: #fff;\n    @media only screen and (hover: none) {\n      height: auto;\n      position: relative;\n      box-shadow: none;\n    }\n    ", " {\n      height: auto;\n      position: relative;\n      box-shadow: none;\n    }\n  }\n\n  .image {\n    background-size: cover;\n    height: 230px;\n    background-blend-mode: screen;\n    -webkit-clip-path: polygon(0 0, 100% 0, 100% 85%, 0 100%);\n    clip-path: polygon(0 0, 100% 0, 100% 85%, 0 100%);\n    border-top-left-radius: 3px;\n    border-top-right-radius: 3px;\n\n    background-image: linear-gradient(\n        to right bottom,\n        ", ",\n        ", "\n      ),\n      url(", ");\n    background-position: center;\n  }\n\n  .back {\n    height: 520px;\n    transition: all 0.8s ease;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    -webkit-backface-visibility: hidden;\n    backface-visibility: hidden;\n    border-radius: 3px;\n    overflow: hidden;\n    box-shadow: 0 15px 40px #00000033;\n    transform: rotateY(180deg);\n    background-image: linear-gradient(\n      to right bottom,\n      ", ",\n      ", "\n    );\n\n    ", " {\n      transform: rotateY(0);\n      height: auto;\n      position: relative;\n      clip-path: polygon(0 15%, 100% 0, 100% 100%, 0% 100%);\n    }\n    @media only screen and (hover: none) {\n      transform: rotateY(0);\n      height: auto;\n      position: relative;\n      clip-path: polygon(0 15%, 100% 0, 100% 100%, 0% 100%);\n    }\n    .back-content {\n      display: flex;\n      height: 520px;\n      flex-direction: column;\n      justify-content: space-evenly;\n      padding: 0 50px;\n      ", " {\n        height: auto;\n        padding: 50px;\n      }\n      @media only screen and (hover: none) {\n        height: auto;\n        padding: 50px;\n      }\n    }\n  }\n\n  &:hover .front {\n    transform: rotateY(-180deg);\n    @media only screen and (hover: none) {\n      transform: rotateY(0);\n    }\n    ", " {\n      transform: rotateY(0);\n    }\n  }\n\n  &:hover .back {\n    transform: rotateY(0);\n  }\n"], ["\n  perspective: 1500px;\n  position: relative;\n  height: 520px;\n\n  ", " {\n    height: auto;\n    box-shadow: 0 1.5rem 4rem #00000033;\n    background-color: #fff;\n  }\n  @media only screen and (hover: none) {\n    height: auto;\n    box-shadow: 0 1.5rem 4rem #00000033;\n    background-color: #fff;\n  }\n\n  .front {\n    height: 520px;\n    transition: all 0.8s ease;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    backface-visibility: hidden;\n    border-radius: 3px;\n    overflow: hidden;\n    box-shadow: 0 15px 40px #00000033;\n    background-color: #fff;\n    @media only screen and (hover: none) {\n      height: auto;\n      position: relative;\n      box-shadow: none;\n    }\n    ", " {\n      height: auto;\n      position: relative;\n      box-shadow: none;\n    }\n  }\n\n  .image {\n    background-size: cover;\n    height: 230px;\n    background-blend-mode: screen;\n    -webkit-clip-path: polygon(0 0, 100% 0, 100% 85%, 0 100%);\n    clip-path: polygon(0 0, 100% 0, 100% 85%, 0 100%);\n    border-top-left-radius: 3px;\n    border-top-right-radius: 3px;\n\n    background-image: linear-gradient(\n        to right bottom,\n        ",
    ",\n        ",
    "\n      ),\n      url(", ");\n    background-position: center;\n  }\n\n  .back {\n    height: 520px;\n    transition: all 0.8s ease;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    -webkit-backface-visibility: hidden;\n    backface-visibility: hidden;\n    border-radius: 3px;\n    overflow: hidden;\n    box-shadow: 0 15px 40px #00000033;\n    transform: rotateY(180deg);\n    background-image: linear-gradient(\n      to right bottom,\n      ",
    ",\n      ",
    "\n    );\n\n    ", " {\n      transform: rotateY(0);\n      height: auto;\n      position: relative;\n      clip-path: polygon(0 15%, 100% 0, 100% 100%, 0% 100%);\n    }\n    @media only screen and (hover: none) {\n      transform: rotateY(0);\n      height: auto;\n      position: relative;\n      clip-path: polygon(0 15%, 100% 0, 100% 100%, 0% 100%);\n    }\n    .back-content {\n      display: flex;\n      height: 520px;\n      flex-direction: column;\n      justify-content: space-evenly;\n      padding: 0 50px;\n      ", " {\n        height: auto;\n        padding: 50px;\n      }\n      @media only screen and (hover: none) {\n        height: auto;\n        padding: 50px;\n      }\n    }\n  }\n\n  &:hover .front {\n    transform: rotateY(-180deg);\n    @media only screen and (hover: none) {\n      transform: rotateY(0);\n    }\n    ", " {\n      transform: rotateY(0);\n    }\n  }\n\n  &:hover .back {\n    transform: rotateY(0);\n  }\n"])), dist.down('xl'), dist.down('xl'), function (props) {
    return props.startColor || props.theme.colors.primaryLight || '#7ed56f';
}, function (props) {
    return props.endColor || props.theme.colors.primaryDark || '#28b485';
}, function (props) { return props.image; }, function (props) {
    return props.startColor || props.theme.colors.primaryLight || '#7ed56f';
}, function (props) {
    return props.endColor || props.theme.colors.primaryDark || '#28b485';
}, dist.down('xl'), dist.down('xl'), dist.down('xl'));
var Heading = styled(H4)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  text-transform: uppercase;\n  text-align: right;\n  position: absolute;\n  top: 120px;\n  right: 4px;\n  width: 75%;\n\n  .heading-inner {\n    line-height: 1.5;\n    box-decoration-break: clone;\n    padding: 8px 10px;\n    background-image: linear-gradient(\n      to right bottom,\n      ", ",\n      ", "\n    );\n  }\n"], ["\n  text-transform: uppercase;\n  text-align: right;\n  position: absolute;\n  top: 120px;\n  right: 4px;\n  width: 75%;\n\n  .heading-inner {\n    line-height: 1.5;\n    box-decoration-break: clone;\n    padding: 8px 10px;\n    background-image: linear-gradient(\n      to right bottom,\n      ",
    ",\n      ",
    "\n    );\n  }\n"])), function (props) {
    return curriedTransparentize(0.2, props.startColor || props.theme.colors.primaryLight || '#7ed56f');
}, function (props) {
    return curriedTransparentize(0.2, props.endColor || props.theme.colors.primaryDark || '#28b485');
});
var List = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  padding: 30px;\n  display: flex;\n  flex-direction: row;\n  align-items: flex-end;\n  ul {\n    list-style: none;\n    width: 80%;\n    margin: 0 auto;\n    padding: 0;\n\n    li {\n      text-align: center;\n      font-size: 15px;\n      padding: 10px;\n\n      &:not(:last-child) {\n        border-bottom: 1px solid ", ";\n      }\n    }\n  }\n"], ["\n  padding: 30px;\n  display: flex;\n  flex-direction: row;\n  align-items: flex-end;\n  ul {\n    list-style: none;\n    width: 80%;\n    margin: 0 auto;\n    padding: 0;\n\n    li {\n      text-align: center;\n      font-size: 15px;\n      padding: 10px;\n\n      &:not(:last-child) {\n        border-bottom: 1px solid ", ";\n      }\n    }\n  }\n"])), function (props) { return props.theme.colors.greyLight2; });
var Button = styled.button(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  border-radius: 100px;\n  background-color: ", ";\n  border: none;\n  text-transform: uppercase;\n  cursor: pointer;\n"], ["\n  border-radius: 100px;\n  background-color: ", ";\n  border: none;\n  text-transform: uppercase;\n  cursor: pointer;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.white;
});
var FlipCard = function (_a) {
    var _b = _a.image, image = _b === void 0 ? "https://picsum.photos/id/1083/800/800" : _b, _c = _a.headingText, headingText = _c === void 0 ? 'Perfect for two' : _c, _d = _a.listItems, listItems = _d === void 0 ? [
        'Romantic time',
        '2 tours',
        '4 days',
        'Luxury accomodation',
        'White beaches',
    ] : _d, _e = _a.value, value = _e === void 0 ? '$300' : _e, startColor = _a.startColor, endColor = _a.endColor;
    var renderListItems = function (items) {
        return items.map(function (item) { return (React.createElement("li", { key: item },
            React.createElement(Paragraph, { color: "greyDark", marginY: "XS" }, item))); });
    };
    return (React.createElement(FlipCardWrapper, { image: image, startColor: startColor, endColor: endColor },
        React.createElement("div", { className: "front" },
            React.createElement("div", { className: "image" }),
            React.createElement(Heading, { startColor: startColor, endColor: endColor, color: "greyLight1" },
                React.createElement("span", { className: "heading-inner" }, headingText)),
            React.createElement(List, null,
                React.createElement("ul", null, renderListItems(listItems)))),
        React.createElement("div", { className: "back" },
            React.createElement("div", { className: "back-content" },
                React.createElement(H4, { margin: "NONE", fontWeight: "300", textAlign: "center", color: "white" }, "Just"),
                React.createElement(H2, { marginY: "XL", fontWeight: "100", color: "white", textAlign: "center" }, value),
                React.createElement(Button, { as: "button" },
                    React.createElement(Paragraph, null, "Find out more!"))))));
};
var templateObject_1$1, templateObject_2, templateObject_3, templateObject_4;

var HeaderWrapper = styled(GenericComponent)(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  clip-path: ", ";\n  background-size: cover;\n  background-position: top;\n  position: relative;\n  background-image: ", ";\n"], ["\n  clip-path: ", ";\n  background-size: cover;\n  background-position: top;\n  position: relative;\n  background-image: ", ";\n"])), function (props) { return props.clipPath; }, function (props) { return props.backgroundImage; });
var HeaderText = styled.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 40%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  text-align: center;\n"], ["\n  position: absolute;\n  top: 40%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  text-align: center;\n"])));
...
export { FlipCard, Header, Typography };
