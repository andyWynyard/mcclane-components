...
var FlipCard = function (_a) {
    ...
    var renderListItems = function (items) {
        return items.map(function (item) { return (React__default.createElement("li", { key: item },
            React__default.createElement(Paragraph, { color: "greyDark", marginY: "XS" }, item))); });
    };
    return (React__default.createElement(FlipCardWrapper, { image: image, startColor: startColor, endColor: endColor },
        React__default.createElement("div", { className: "front" },
            React__default.createElement("div", { className: "image" }),
            React__default.createElement(Heading, { startColor: startColor, endColor: endColor, color: "greyLight1" },
                React__default.createElement("span", { className: "heading-inner" }, headingText)),
            React__default.createElement(List, null,
                React__default.createElement("ul", null, renderListItems(listItems)))),
        React__default.createElement("div", { className: "back" },
            React__default.createElement("div", { className: "back-content" },
                React__default.createElement(H4, { margin: "NONE", fontWeight: "300", textAlign: "center", color: "white" }, "Just"),
                React__default.createElement(H2, { marginY: "XL", fontWeight: "100", color: "white", textAlign: "center" }, value),
                React__default.createElement(Button, { as: "button" },
                    React__default.createElement(Paragraph, null, "Find out more!"))))));
};
